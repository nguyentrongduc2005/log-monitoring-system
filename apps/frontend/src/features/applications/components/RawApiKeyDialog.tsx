...
export default function RawApiKeyDialog({
  ...
  return (
    <DialogShell
      ...
      footer={
        <button
          className="min-h-11 rounded-xl bg-primary px-5 text-sm font-semibold text-black transition hover:bg-primary-hover"
          onClick={onClose}
          type="button"
        >
          I copied this key
    ...
    >
      <div className="space-y-4">
        ...
        <div>
          ...
          <code className="block overflow-x-auto rounded-xl border border-border bg-background p-4 font-mono text-sm text-primary">
            {apiKey.rawApiKey}
          </code>
        </div>
